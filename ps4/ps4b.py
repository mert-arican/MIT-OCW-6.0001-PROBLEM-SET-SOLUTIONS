...
def is_word(word_list, word):
    ...
    False
    '''
    word = word.lower(); word_list = load_words(WORDLIST_FILENAME)
    word = word.strip(" !@#$%^&*()-_+={}[]|\:;'<>?,./\"")
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for letter in all_letters:
            ...
            if not index < 26:
                new_index += 26
            shift_dict[letter] = all_letters[new_index]
        return shift_dict
...
class PlaintextMessage(Message):
    ...
    def change_shift(self, shift):
        ...
        Returns: nothing
        '''
        self.message_text = self.get_message_text() ; self.shift = shift
        self.encryption_dict = self.build_shift_dict(shift)
        self.message_text_encrypted = self.apply_shift(shift)
        ...
        for shift in range(27):
            ...
            for word in shifted_message_list:
                if is_word(self.get_valid_words,word):
                    a += 1
            shift_list.append(shifted_message) ; a_list.append(a)
        best_shift = a_list.index(max(a_list))
        return (26 - best_shift, shift_list[best_shift])
